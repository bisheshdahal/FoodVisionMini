...
# ├── foodvision\_mini.ipynb   # main notebook — start here

# ├── data\_setup.py           # downloads the dataset + builds DataLoaders

# ├── model\_builder.py        # TinyVGG, the CNN itself

# ├── engine.py                # train\_step / test\_step / the full train loop
...
# A small subset of \[Food101](https://data.vision.ee.ethz.ch/cvl/datasets\_extra/food-101/): just 3 classes (pizza, steak, sushi), roughly 75 training images and 25 test images per class. Small enough that the whole thing trains fast, which matters when you're iterating and re-running cells constantly.
...
# jupyter notebook foodvision\_mini.ipynb
